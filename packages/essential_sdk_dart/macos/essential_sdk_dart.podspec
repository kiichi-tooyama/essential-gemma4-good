Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = {
    ...
    'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) GGML_USE_CPU GGML_USE_ACCELERATE GGML_USE_METAL=0 GGML_USE_CUDA=0 GGML_USE_VULKAN=0 GGML_USE_SYCL=0 GGML_USE_OPENCL=0 _DARWIN_C_SOURCE',
    'HEADER_SEARCH_PATHS' => '$(inherited) "${PODS_TARGET_SRCROOT}/../../../native/inference_core/include" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/include" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/src" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/src/models" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/ggml/include" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/ggml/src" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/ggml/src/ggml-cpu" "${PODS_TARGET_SRCROOT}/../../../native/runtimes/llama/llama.cpp/ggml/src/ggml-cpu/arch/arm"'
  }
  s.swift_version = '5.0'
end